_base_ = [
    '../_base_/models/upernet_beit.py', '../_base_/datasets/ade20k_320x320.py',
...
model = dict(
    ...
    test_cfg=dict(mode='slide', crop_size=(320, 320), stride=(426, 426)))
...
train_pipeline = [
    ...
    dict(
        ...
        scales=[int(x * 0.1 * 320) for x in range(5, 21)],
