...
class BEiT_adapter(BaseModule):
    ...
    def __init__(self,
        ...
        self.norm_1 = nn.SyncBatchNorm(embed_dims)
        self.norm_2 = nn.SyncBatchNorm(embed_dims)
        self.norm_3 = nn.SyncBatchNorm(embed_dims)
        self.norm_4 = nn.SyncBatchNorm(embed_dims)
    ...
    def forward(self, inputs):
        deform_inputs1, deform_inputs2 = deform_inputs(inputs)
        ...
        for i, layer in enumerate(self.interactions):
            ...
            x, c, cls = layer(x, c, cls_tokens, self.layers[indexes[0]:indexes[-1] + 1],
                              deform_inputs1, deform_inputs2, hw_shape[0], hw_shape[1])
            outs.append(x.transpose(1, 2).view(B, dim,hw_shape[0], hw_shape[1]).contiguous())
